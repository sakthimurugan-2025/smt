...
def backup_view(request):
    ...
    def send_telegram_message(bot_api_key, user_id, message):
    ...
    try:
        ...
        message = f"Database Backup:\n\n{json_data[:4000]}"  # Telegram has a message size limit
        send_telegram_message(bot_api_key, user_id, message)

        return JsonResponse({'success': True, 'message': 'Backup sent to Telegram successfully'})
    except Exception as e:
        return JsonResponse({'success': False, 'error': str(e)})
